...
export const Guidesflows = () => {
  return (
    <section className="min-h-screen px-8 py-16 bg-[var(--background)] text-[var(--foreground)] text-center">
      ...
      <div className="mt-10 flex flex-col md:flex-row gap-12 justify-center items-center">
        {/* Trainer 1 */}
        <img
          src={trainer1}
          alt="Trainer 1"
          className="w-full max-w-sm md:max-w-md lg:max-w-lg h-auto object-cover rounded-xl shadow-lg border border-[var(--foreground)]/20
